    <script>
        $(document).ready(function() {
            ...
            @can('create_perkara_perguruan_tinggi')
            const addButton = {
                text: '+ Add New',
                attr: {
                    id: 'add-new-perkara',
            ...
            const table = $('#table_perkara').DataTable({
                dom: 'Bfrtip',
                buttons: tableButtons,
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route("berita-acara-perkara.getByIdOrganization", ["id_organization" => ":pertiId"]) }}'.replace(':pertiId', pertiId),                
                },
                columns: [
                    {
                        data: 'bap_defined_id',
    ...
    <script>
        $(document).ready(function() {
            $('#add-new-perkara').click(function() {
                var url = '{{ route("berita-acara-perkara.create", ['id_perti' => $pertiId]) }}';
