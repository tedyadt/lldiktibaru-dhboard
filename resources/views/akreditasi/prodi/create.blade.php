...
@php
    ...
    $prodiId = $_GET['id_prodi'];
@endphp
<div class="main-content pt-4">
    <div class="breadcrumb">
        <ul>
            <li><a href="{{ route('akreditasi', ['id_perti' => $pertiId]) }}">Akreditasi</a></li>
            <li>tambah</li>
        </ul>
    </div>
    <div class="separator-breadcrumb border-top"></div><!-- end of main-content -->
    <form action="{{ route('akreditasi', ['id_prodi' => $prodiId, 'id_perti' => $pertiId]) }}"  method="post"  enctype="multipart/form-data">
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row">
                                @csrf
                                <input type="hidden" readonly name="id_prodi" value="{{ $prodiId }}">
                                <input type="hidden" readonly name="id_organization" value="{{ $pertiId }}">
