...
@php
$prodiId = $prodi->prodi_defined_id;
$pertiId = $id_perti;
@endphp
    ...
    <div class="breadcrumb">
        <ul>
            <li>
                ...
                <a href="{{ route('program-studi.show',  $pertiId ) }}">Detail</a> |
            </li>
        </ul>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 mb-4">
            <div class="card text-left">
                <div class="card-body">
                        @include('akreditasi.datatable.prodi.index')
                </div>
            </div>
        </div>
    </div>
...
@section('page-js')
    ...
    @include('akreditasi.datatable.prodi.js')
